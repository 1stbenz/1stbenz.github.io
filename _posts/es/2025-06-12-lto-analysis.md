...
faq:
  ...
  - question: "¿Por qué la tasa de descarga continua de LTO es menor que la de LiFePO4 a pesar de tener menor resistencia interna?"
    answer: "Principalmente por la 'polarización por concentración' en el cátodo y una 'ventana de voltaje extremadamente estrecha'. LTO tiene un voltaje nominal de solo 2.3V y de corte de 1.5V, con un margen utilizable de solo ~0.8V (mucho menor que los 1.2V de LiFePO4). Con alta corriente, la caída de tensión y la polarización superan rápidamente el umbral de 1.5V provocando el corte, incluso sin sobrecalentamiento."
...
Primero, **la resistencia interna de una batería de litio no equivale a su capacidad real de descarga**. Tomando como ejemplo la [hoja de especificaciones oficial de LTO de Toshiba](https://www.global.toshiba/ww/products-solutions/battery/scib/product-next/product/cell/high-energy.html), su tasa de descarga es en realidad de solo 20C. Medir un CCA ultra alto usando instrumentos tradicionales prácticamente no tiene sentido (Lectura adicional: [Por qué medir el CCA para baterías de litio no tiene sentido](/2025/about-cca.html)).

¿Por qué la tasa de descarga continua de LTO es inferior a la de LiFePO4 (20C vs. 50C–80C) a pesar de tener una resistencia interna mucho menor? Las razones clave son:
* **Polarización por concentración en el cátodo**: La bajísima resistencia interna de las especificaciones es solo una impedancia estática o instantánea. Durante una descarga continua de alta corriente, la difusión de iones de litio en el cátodo no puede seguir el ritmo (polarización por concentración), lo que provoca una rápida caída de voltaje.
* **Ventana de caída de voltaje extremadamente estrecha**: LTO tiene un voltaje nominal de solo 2.3V (voltaje de corte 1.5V), ofreciendo un margen de caída de solo ~0.8V (mucho menor que los 1.2V de LiFePO4). Bajo una corriente alta, cualquier ligera caída de voltaje y polarización cae instantáneamente por debajo del límite de 1.5V, haciendo que el sistema se apague por bajo voltaje.
