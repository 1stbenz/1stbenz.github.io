...
categories: Auto
tags: [Titanato de litio, LTO, Batería de coche, Batería modificada, 5S, 6S, DIY, Ajuste de voltaje, Punto ciego del medidor de resistencia interna]
description: "¿Estás pensando en modificar una batería de Titanato de Litio (LTO)? Primero comprende el defecto fatal del ajuste de voltaje. Este artículo analiza por qué los 14V del alternador de un coche provocan que el LTO de 5 celdas (5S) se sobrecargue y se dañe, deja al LTO de 6 celdas (6S) con solo un 30% de capacidad, y expone los mitos sobre los altos CCA y los puntos ciegos de usar medidores de resistencia interna de 1kHz en celdas LTO de segunda mano."
keywords: "Titanato de litio, LTO, SCiB, 5S, 6S, Desajuste de voltaje, Sobrecarga, Modificación de coche, Batería de litio, Toshiba, Prueba de resistencia interna"
...
## ¿Por qué 6S no se carga por completo?
...
## Descubriendo la ilusión de los datos LTO: La estafa de los ultra altos CCA y la resistencia interna
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    x Capacidad 0.46<br>
                    <span style="color: red;">x Desgaste de uso 0.7 (indetectable)</span><br>
            ...
            <tr>
                ...
                <td><span style="color: red;">Mayormente usada/desmontada (difícil de detectar)</span></td>
                <td>Totalmente Nueva</td>
            </tr>
            <tr>
                <td>Fabricante</td>
