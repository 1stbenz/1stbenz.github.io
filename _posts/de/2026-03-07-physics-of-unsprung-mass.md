---
layout: post
title: "Tiefenanalyse: Die physikalische Wahrheit hinter 1 kg ungelagert und 10 kg gelagert"
lang: de
...
faq:
  - question: "Was ist die Masse auf der Federung und die Masse unter der Federung?"
    answer: "Die Masse auf der Federung bezieht sich auf das Gewicht, das vom Fahrwerksystem getragen wird (einschließlich Karosserie, Motor, Passagiere usw.); die Masse unter der Federung ist das Gewicht, das nicht von der Federung getragen wird und dem Straßenprofil direkt folgt (einschließlich Reifen, Felgen, Bremssystem und Teile des Fahrwerks)."
  - question: "Was bringt die Verringerung der ungelagerten Masse für das Fahrzeug?"
    answer: "Die Reduzierung der ungelagerten Masse kann den kinetischen Energieaufschlag, mit dem die Räder beim Überqueren von Gruben nach oben geschleudert werden, erheblich verringern. Dies führt zu einer schnelleren und sensibleren Reaktion des Federungssystems, wodurch sich das Reifenprofil fester an die Fahrbahnfläche anpasst und insgesamt die Fahrleistungen sowie der Straßenkontakt verbessert wird."
  - question: "Warum fühlt sich das Auto nach dem Wechsel auf leichtere, größere Felgen beim Start plötzlich schwerer an?"
    answer: "Dies liegt daran, dass die Vergrößerung der Felgengröße (z. B. vom 17- bis zum 19-Zoll) dazu führt, dass die Massenverteilung stärker in den Außenbereich verschoben wird und das Trägheitsmoment stark ansteigt. Selbst wenn sich das Gesamtgewicht reduziert hat, muss der Motor mehr Energie aufwenden, um dem Rotationswiderstand zu widerstehen, was einen Gefühl von schwerem Start erzeugt."
---
...
![Auf- und ungebundene Masse](/images/physics-of-unsprung.webp)  
...
In der Formel ist $\frac{1}{2}mv^2$ die kinetische Energie, mit der sich das Rad vorwärts bewegt, während $\frac{1}{2}I\omega^2$ die Rotationsenergie des Rades darstellt ($I$ bezeichnet den Trägheitsmoment und $\omega$ die Winkelgeschwindigkeit).
