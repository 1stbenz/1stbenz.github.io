...
related_posts:
  - 2025-06-12-lto-analysis.md
  - 2025-03-20-about-cca.md
...
| **Zusammenfassung** | Hohe Energie, schlechte Sicherheit, passable Kälte | Mittlere Energie, mittlere Sicherheit, gute Kälte | Niedrige Energie, hohe Sicherheit, schlechte Kälte |
...
1. **Nachteil bei der Energiedichte**:
   - **LFP (Lithium-Eisenphosphat)**: Die volumetrische Energiedichte erreicht **400–500 Wh/L** (Gewichtsenergiedichte ca. 140–180 Wh/kg). Bei gleichen Außenabmessungen bietet es eine größere Kapazität und einen höheren Kaltstartstrom (CCA) bei nur 1/3 bis 1/4 des Gewichts herkömmlicher Blei-Säure-Batterien – die erste Wahl für Leichtbau.
   - **Natrium-Ionen-Batterie**: Die volumetrische Energiedichte liegt nur bei etwa **200–250 Wh/L**. Um denselben Startstrom und dieselbe tatsächliche Kapazität zu erreichen, nehmen Volumen und Gewicht einer Natriumbatterie erheblich zu.
...
<style>
    ...
    /* Empfohlenes Produkt (LFP) */
    .battery-table th.recommend {
        background-color: #1e8e3e !important;
        color: #ffffff !important;
    }
    .battery-table td.recommend {
        background-color: #e6f4ea !important;
        font-weight: bold;
        color: #137333 !important;
    }
    .battery-table tbody tr:hover td.recommend {
        background-color: #d2ebd9 !important;
    }
    
    /* Schlechtestes Produkt */
    .battery-table td.worst {
        background-color: #fce8e6 !important;
        color: #c5221f !important;
        font-weight: bold;
    }
    .battery-table tbody tr:hover td.worst {
    ...
    <table class="battery-table">
        <thead>
            <tr>
                ...
                <th class="recommend">Lithium-Eisenphosphat (LFP)</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td class="worst">Kapazität reduziert (Bei 14,4 V nicht im Hochspannungsbereich ladbar)</td>
                <td class="recommend">Voll aufladbar (>95 % nutzbare Kapazität)</td>
            </tr>
            <tr>
                <td><b>14,4-V-Lichtmaschinen-Passgenauigkeit</b></td>
                <td>Gut</td>
                <td class="worst">Schlecht (Kann nicht voll laden)</td>
                <td class="recommend">Gut</td>
            </tr>
            <tr>
                <td><b>Gleichmäßigkeit der Entladespannung</b></td>
                <td>Akzeptabel</td>
                <td class="worst">Schlecht (Starker Abfall, fällt bei geringer Kapazität leicht unter 11 V)</td>
                <td class="recommend">Extrem hoch (Bleibt selbst bei 20 % Restkapazität >13 V)</td>
            </tr>
            <tr>
                <td><b>Thermisches Durchgehen & Sicherheit</b></td>
                <td>Gut</td>
                <td class="worst">Schlecht (Sauerstofffreisetzung speist Brand)</td>
                <td class="recommend">Gut (>270 °C, setzt von Natur aus keinen Sauerstoff frei)</td>
            </tr>
            <tr>
                <td><b>Hitzetoleranz im Motorraum</b></td>
                <td>Gut</td>
                <td class="worst">Schlecht (Neigt bei Hitze zu Blähung)</td>
                <td class="recommend">Gut (Lange Lebensdauer bei hohen Temperaturen)</td>
            </tr>
            <tr>
                <td><b>Zykluslebensdauer</b></td>
                <td class="worst">500 – 1.000 Zyklen</td>
                <td>1.500 – 2.000 Zyklen</td>
                <td class="recommend">4.000 – 6.000 Zyklen</td>
            </tr>
            <tr>
                <td><b>Selbstentladungsrate</b></td>
                <td class="worst">5%–15%/Monat</td>
                <td>5%–10%/Monat</td>
                <td class="recommend">1%–2%/Monat</td>
            </tr>
            <tr>
                <td><b>Herkunft der Zellqualität</b></td>
                <td>Reguläre Fahrzeugqualität</td>
                <td class="worst">Meist Zweit- oder Drittanbieter-Hersteller</td>
                <td class="recommend">Erstklassige Lithium-Hersteller</td>
            </tr>
        </tbody>
    </table>
</div>
