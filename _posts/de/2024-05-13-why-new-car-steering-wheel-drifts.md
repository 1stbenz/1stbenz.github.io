---
layout: post
title: "Warum neigt das Lenkrad beim Neuwagen leicht? Ist es ein Mangel oder normaler Zustand?"
lang: de
...
faq:
  - question: "Ist das leichte Lenkradverzug beim Neuwagen ein Hinweis auf einen Mängelfahrzeug?"
    answer: "Nicht unbedingt. Oft sind es Faktoren wie der Straßenneigungswinkel, die Kraftstofflenkung oder die Nullpunkteinstellung des EPS-Elektronischen-Steuersystems, also eher konstruktive und physikalische Gründe als ein Fehler am Fahrzeug selbst."
  - question: "Was ist die Lenkungsneigung, die durch den Straßenverlauf verursacht wird?"
    answer: "Um ein effizientes Entwässerungssystem zu gewährleisten, sind öffentliche Straßen in der Regel als leicht gewölbte Struktur mit höherem Mittelteil und niedrigeren Rändern ausgelegt. Wenn man auf Taiwan rechtsfahrend ist, gleitet das Fahrzeug unbewusst nach rechts ab; der Fahrer korrigiert dann unbewusst den Lenkradstand nach links, was zu einer falschen Wahrnehmung eines nicht zentrierten Lenkers führt."
  - question: "Was ist «Torque Steer»?"
    answer: "Viele Frontantriebsfahrzeuge (wie der RAV4) verwenden einen quer eingebauten Motor, was zu unterschiedlichen Längen der Antriebswellen auf beiden Seiten führt. Bei starkem Beschleunigen durch Betätigen des Gaspedals kommt es zu zeitlichen und winkelweisen Unterschieden in der Kraftübertragung an den Reifen beider Achsen, wodurch das Fahrzeugfrontende plötzlich nach einer Seite zieht."
  - question: "Was passiert, wenn das Lenkrad nach einer Seite zieht? Was sollte der Fahrer tun?"
    answer: "Es wird empfohlen, zunächst auf einem sicheren, ebenen und geschlossenen Abschnitt ohne deutliche Abflussneigung zu testen. Führt die Ausrichtung auch beim Tempomat weiterhin deutlich abweichend aus, sollten Sie zum Originalhersteller zurückkehren lassen, damit ein Fachmann den Reifendruck und die Radauswuchtung überprüft sowie das EPS-System auf Null setzt."
---

![Schematische Darstellung der Lenkradverlagerung](/images/steering-wheel-drift.webp)
