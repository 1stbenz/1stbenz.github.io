...
faq:
  ...
  - question: "Warum ist die Dauerentladerate von LTO trotz sehr geringem Innenwiderstand geringer als bei LiFePO4?"
    answer: "Hauptsächlich wegen der 'Konzentrationspolarisation' an der Kathode und des 'extrem engen Spannungsfensters'. LTO hat nur 2,3V Nennspannung und 1,5V Schlussspannung, mit einem nutzbaren Spielraum von nur ca. 0,8V (weit geringer als die 1,2V bei LiFePO4). Bei hoher Last fällt die Spannung sofort unter 1,5V ab und das System schaltet wegen Unterspannung ab, selbst wenn die Temperatur noch unkritisch ist."
...
Erstens: **Der Innenwiderstand einer Lithiumbatterie entspricht nicht ihrer tatsächlichen Entladefähigkeit**. Nimmt man das [offizielle LTO-Datenblatt von Toshiba](https://www.global.toshiba/ww/products-solutions/battery/scib/product-next/product/cell/high-energy.html) als Beispiel, so beträgt die Entladerate tatsächlich nur 20C. Die Messung eines extrem hohen CCA-Wertes mit herkömmlichen Instrumenten ist in der Praxis bedeutungslos (Weitere Informationen: [Warum die CCA-Messung bei Lithiumbatterien sinnlos ist](/2025/about-cca.html)).

Warum ist die Dauerentladerate von LTO trotz extrem geringem Innenwiderstand schlechter als bei LiFePO4 (20C vs. 50C–80C)? Die entscheidenden Gründe:
* **Konzentrationspolarisation an der Kathode**: Der im Datenblatt angegebene niedrige Innenwiderstand ist lediglich eine statische oder momentane Impedanz. Bei dauerhaft hoher Stromentnahme kommt die Lithium-Ionen-Diffusion an der Kathode nicht hinterher (Konzentrationspolarisation), wodurch die Spannung rapide einbricht.
* **Extrem enges Spannungsfenster**: LTO hat eine Nennspannung von nur 2,3V (Entladeschlussspannung 1,5V), was einen nutzbaren Spannungsabfall von nur ca. 0,8V bietet (weit geringer als die 1,2V bei LiFePO4). Unter hoher Last führen geringste Spannungsabfälle und Polarisation dazu, dass sofort die 1,5V-Grenze unterschritten wird und das System abschaltet.
