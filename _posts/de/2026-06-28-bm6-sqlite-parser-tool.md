---
layout: post
title:  "BM6 Batterietest-Datenbank (SQLite) Parser"
lang: de
...
faq:
  - question: "Was ist der Unterschied zwischen diesem Parser und dem monatlichen Protokolldatei-Analysetool?"
    answer: "Dieses Tool liest direkt die vollständige SQLite-Datenbankdatei, die die BM6 APP lokal auf Ihrem Telefon speichert. Neben der Analyse von monatlichen historischen Spannungs- und Fahrdaten kann es auch hochfrequente (100Hz) Motorstarttest-Spannungswellenformen (Cranking Waveform) und Lade-/Wellen-Erkennungsaufzeichnungen analysieren."
  - question: "Wie erhalte ich die BM6.sqlite-Datei?"
    answer: "Auf Ihrem iPhone oder Android-Telefon können Sie über Dateifreigabe- oder Backup-Software (wie iTunes, iMazing, Android File Transfer usw.) in das Sandbox-Verzeichnis (Documents) der BM6 APP navigieren, um die Datenbankdatei namens BM6.sqlite oder BM6.db zu finden."
...
<div id="bm6-sqlite-app-container">
    ...
    <h2 id="ui-title" style="text-align: center; color: #c9d1d9; margin-bottom: 10px; margin-top: 10px;">BM6 Batterietest-Datenbank (SQLite) Parser</h2>
    ...
    <div class="upload-section" style="margin-bottom: 30px; padding: 20px; background: #161b22; border-radius: 8px; border: 2px dashed #1f6feb; text-align: center;">
        <p>Bitte wählen Sie Ihre <b>BM6.sqlite</b>-Datei aus (Daten werden vollständig auf Ihrem Computer verarbeitet und nicht hochgeladen):</p>
    ...
    <div id="filter-section" style="display: none; background: #161b22; padding: 20px; border-radius: 8px; margin-bottom: 30px; border: 1px solid #30363d; text-align: center;">
        <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: center; justify-content: center;">
            <div style="display: flex; align-items: center; gap: 8px;">
                <label style="font-weight: bold; color: #c9d1d9;">Gerät auswählen (MAC):</label>
            ...
            <div style="display: flex; align-items: center; gap: 8px;">
                <label style="font-weight: bold; color: #c9d1d9;">Monat auswählen:</label>
    ...
    <div id="history-section" class="section">
        <h2>📈 Historische Monatsdaten & Fahrtenanalyse</h2>
        <div style="background: rgba(210, 153, 34, 0.1); padding: 15px 20px; border-radius: 10px; margin-bottom: 25px; border-left: 5px solid #d29922; font-size: 14.5px; line-height: 1.6; color: #8b949e;">
            <strong style="color: #d29922;">Historische Fahrtenanalyse</strong><br>
            <span>Automatische Analyse von historischen Spannungs- und Temperaturschwankungen, Erkennung von Fahrten und Statistik der Generator- und Batteriezustand. Unterstützt Scrollrad/Zwei-Finger-Zoom und Drag-Panning.</span>
        </div>
        ...
        <div style="background: #161b22; border: 1px solid #30363d; padding: 15px 25px; border-radius: 10px; margin-bottom: 25px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px;">
            <div style="display: flex; gap: 10px; align-items: center;">
                <label style="font-weight: bold; color: #c9d1d9; font-size: 14px;">Anzeigebereich:</label>
            ...
            <button id="exportCsvBtn" style="padding: 8px 16px; border-radius: 8px; border: 1px solid #30363d; font-size: 14px; background: #21262d; color: #58a6ff; font-weight: bold; cursor: pointer; transition: 0.2s; white-space: nowrap;">
                📥 Aktuellen Bereich als CSV exportieren
            </button>
        </div>

        <div id="stats-container" class="stats-grid">
            <div class="stat-card" style="background: rgba(31, 111, 235, 0.1); border: 1px solid rgba(31, 111, 235, 0.3);">
                <div style="font-size: 13px; color: #58a6ff; margin-bottom: 5px; font-weight: 500;">Gesamtzahl der Fahrten</div>
            ...
            <div class="stat-card" style="background: rgba(227, 76, 38, 0.1); border: 1px solid rgba(227, 76, 38, 0.3);">
                <div style="font-size: 13px; color: #f0883e; margin-bottom: 5px; font-weight: 500;">Niedrigste Spannung (Kaltstart)</div>
            ...
            <div class="stat-card" style="background: rgba(137, 87, 229, 0.1); border: 1px solid rgba(137, 87, 229, 0.3);">
                <div style="font-size: 13px; color: #a371f7; margin-bottom: 5px; font-weight: 500;">Durchschnittliche Fahrspannung (Generator)</div>
        ...
        <div id="trip-section" style="margin-top: 20px; padding: 15px; background: #161b22; border-radius: 10px; border: 1px dashed #30363d; display: none; margin-bottom: 30px;">
            <h3 id="ui-trip-title" style="color: #c9d1d9; font-size: 16px; margin-top: 0; margin-bottom: 15px;">Erkannte Fahrten</h3>
            <div id="trip-list" style="display: flex; flex-direction: column; gap: 8px;"></div>
        </div>
    </div>

    <div id="charging-section" class="section">
        <h2>⚡ Lade- & Wellenprüfungsprotokoll</h2>
        <p>Diese Tabelle zeichnet Daten wie Ladespannung im Leerlauf/bei hoher Geschwindigkeit und Diodenwelligkeitsspannung auf.</p>
        <table id="charging-table">
            <thead>
                <tr>
                    <th style="width: 25%;">Geräte- & Zeitinformationen</th>
                    <th style="width: 75%;">Analysierte Schlüsseldaten (mit APP synchronisiert)</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
    ...
    <div id="cranking-section" class="section">
        <h2>🚗 Startwellenform</h2>
        <p>Diese Tabelle zeichnet hochfrequente Spannungsschwankungen auf und wurde automatisch für Sie grafisch dargestellt.</p>
        <div id="cranking-stats-container" class="stats-grid-2">
            <div class="stat-card" style="background: rgba(31, 111, 235, 0.1); border: 1px solid rgba(31, 111, 235, 0.3);">
                <div style="font-size: 13px; color: #58a6ff; margin-bottom: 5px; font-weight: 500;">Durchschnittliche Startzeit</div>
            ...
            <div class="stat-card" style="background: rgba(227, 76, 38, 0.1); border: 1px solid rgba(227, 76, 38, 0.3);">
                <div style="font-size: 13px; color: #f0883e; margin-bottom: 5px; font-weight: 500;">Durchschnittliche Startspannung</div>
...
<script>
    ...
    document.getElementById('dbfile').addEventListener('change', function(event) {
        ...
        reader.onload = function() {
            if(!SQL) {
                alert("SQL.js wird noch geladen, bitte warten Sie einen Moment und versuchen Sie es erneut.");
                return;
            }
            ...
            try {
                ...
                alert("Fehler beim Lesen der Datenbank, bitte überprüfen Sie, ob die Datei korrekt ist. Fehlermeldung: " + err.message);
            }
        };
        reader.readAsArrayBuffer(file);
    });

    // Leichter Apple Binary Plist (bplist00) und NSKeyedArchiver Parser
    ...
    // Handle tbl_charging (ripple and charging)
    function parseChargingTable(db, serial, month) {
        ...
        try {
            // In tbl_charging, the column name is 'serial' instead of 'mac'
            ...
            if (res.length === 0) {
                tbody.innerHTML = '<tr><td colspan="2">Für dieses Gerät/diesen Monat liegen keine Ladeprüfungsaufzeichnungen vor.</td></tr>';
                return;
            }
            ...
            values.forEach(row => {
                ...
                const mac = row[macIndex] || "Unbekanntes Gerät";
                
                let date = "Unbekannte Zeit";
                ...
                let rippleVolStr = "Keine Daten";
                let loadVolStr = "Keine Daten";
                let noLoadVolStr = "Keine Daten";
                ...
                if (blob) {
                    try {
                        ...
                        if (parsedData) {
                            // 1. Handle diode ripple voltage (Ripple) and unit conversion (V -> mV)
                            if (parsedData.rippleVol !== undefined) {
                                let rVal = Number(parsedData.rippleVol);
                                // If data is less than 1 (e.g., 0.001 V), convert to millivolts (1 mV)
                                if (rVal > 0 && rVal < 1) {
                                    rVal = rVal * 1000;
                                }
                            ...
                            // 2. Handle high-speed charging voltage (Load)
                            loadVolStr = parsedData.loadVol !== undefined ? `${Number(parsedData.loadVol).toFixed(2)} V` : "Keine Daten";
                            
                            // 3. Handle idle charging voltage (NoLoad)
                            noLoadVolStr = parsedData.noLoadVol !== undefined ? `${Number(parsedData.noLoadVol).toFixed(2)} V` : "Keine Daten";
                            
                            parseSuccess = true;
                        }
                    } catch (err) {
                        console.error("Fehler beim Parsen von bplist:", err);
                    }
                }
                ...
                tr.innerHTML = `
                    ...
                    <td>
                        <b>Ladespannung im Leerlauf (NoLoad):</b> <span style="color:#58a6ff; font-weight:bold;">${noLoadVolStr}</span> <br>
                        <b>Ladespannung bei hoher Geschwindigkeit (Load):</b> <span style="color:#3fb950; font-weight:bold;">${loadVolStr}</span> <br>
                        <b>Diodenwelligkeitsspannung (Ripple):</b> <span style="color:#d2a8ff; font-weight:bold;">${rippleVolStr}</span> <br>
                        <small style="color:gray;">Analysestatus: ${parseSuccess ? "🟢 Erfolgreich analysiert" : "🔴 Analyse fehlgeschlagen"}</small>
                    </td>
                `;
                tbody.appendChild(tr);
            });
        } catch (e) {
            tbody.innerHTML = `<tr><td colspan="2">Analysefehler: ${e.message}</td></tr>`;
        }
    }
    ...
    // Handle tbl_cranking (starting waveform)
    function parseCrankingTable(db, serial, month) {
        ...
        try {
            ...
            const res = db.exec(sql);
            if (res.length === 0) {
                container.innerHTML = '<p>Für dieses Gerät/diesen Monat liegen keine Startwellenform-Aufzeichnungen vor.</p>';
            ...
            values.forEach((row, index) => {
                ...
                if (extractedNumbers.length > 0) {
                    ...
                    // 3. Starter motor disengagement point (Starter Disengaged)
                    ...
                    // Startzeit berechnen und Statistiken akkumulieren (berechnet bis Starter-Trennung/Orangener Punkt)
                    let startIdx = minIdx;
                    ...
                    if (serialIndex !== -1 && row[serialIndex] && ts) {
                        ...
                        try {
                            ...
                            console.error("Fehler beim Abfragen der historischen Temperatur:", tempErr);
                        }
                    }

                    let titleText = `Startwellenform-Analyse - Startzeit: ${crankingDuration.toFixed(2)}s - `;
                    if (dateStr) {
                        titleText += ` (Zeit: ${dateStr})`;
                    } else if (dateIndex !== -1 && row[dateIndex]) {
                        titleText += ` Zeit: ${row[dateIndex]}`;
                    }
                    if (eventTemp !== null && eventTemp !== undefined) {
                        titleText += ` (Temperatur: ${eventTemp}°C)`;
                    } else if (tempIndex !== -1 && row[tempIndex] !== undefined) {
                        titleText += ` (Temperatur: ${row[tempIndex]}°C)`;
                    }
                                ...
                                tooltip: {
                                    ...
                                    callbacks: {
                                        ...
                                        label: function(context) {
                                            ...
                                            return `Zeit: ${context.raw.x.toFixed(2)} Sekunden`;
                                        }
                                    }
                                },
                                zoom: {
                    ...
                    wrapper.innerHTML = `<h3>Testaufzeichnung #${row[0] || index + 1}</h3><p style="color:red; margin: 15px 0;">Es konnten keine kontinuierlichen Spannungswerte aus diesem Datensatz extrahiert werden.</p><hr>`;
            ...
            container.innerHTML = `<p>Fehler beim Lesen: ${e.message}</p>`;
            document.getElementById('cranking-stats-container').style.display = 'none';
        }
    }
    ...
    function initHistoryCharts() {
        ...
        tChart = new Chart(document.getElementById('tempChart'), createChartConfig('Temperatur (℃)', '#f85149', 'Temperatur (℃)'));
    }
    ...
    function parseHistoryTable(db, serial, month) {
        ...
        try {
            ...
            if (res.length === 0) {
                ...
                document.getElementById('dateSelector').innerHTML = '<option value="all">-- Kein Datum --</option>';
                return;
            }
    ...
    function renderTrips(result) {
        ...
        const modeSuffix = result.mode === 'LiFePO4' ? ' [LiFePO4-Modus]' : ' [Blei-Säure / Ladesteuerungsmodus]';
        ...
        result.trips.forEach((t, i) => {
            ...
            rowDiv.innerHTML = `<span style="font-size: 14px; color: #c9d1d9;"><b style="color:#58a6ff;">Fahrt ${i+1}</b>：${t.startStr} ~ ${t.endStr} (Dauer ${t.duration} Minuten)</span>`;

            const btn = document.createElement('button');
            btn.innerHTML = '🔍 Diagramm zoomen';
    ...
    function initDeviceSelector(db) {
        ...
        if (serials.size === 0) {
            alert("Es wurden keine Geräte-MAC-Daten in der Datenbank gefunden!");
            return;
        }
    ...
    function initMonthSelector(db, serial) {
        ...
        monthSelector.innerHTML = '<option value="all">-- Alle Monate --</option>';
    ...
    function exportVisibleHistoryCsv() {
        if (!allData || allData.length === 0) {
            alert("Keine historischen Daten zum Exportieren verfügbar.");
            return;
        }
        ...
        if (visibleData.length === 0) {
            alert("Keine Daten im aktuellen Anzeigebereich.");
            return;
        }
