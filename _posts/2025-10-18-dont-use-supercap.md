...
**直接告訴你答案：加裝超級電容，不光是昂貴的彎路，甚至是帶來反效果的「負升級」。**
...
用公式計算，GreenRun鋰鐵並聯Eaton超級電容，總內阻只能降低 **約 0.15mΩ**，甚至可能被接線阻抗抵消。  
...
*   **如果你用鉛酸電池：** 並聯電容是**不划算**的，因為直接換鋰鐵得到的效能更強。

👉 把買超級電容的預算省下來，直接投資一顆品質優良的鋰鐵電池。這才是**最直接有效的升級方式**。