---
layout: post
title: "JASO MB for Motorcycles vs. API & OEM Approvals for Cars"
lang: en
...
faq:
  - question: "Why isn't a JASO MB oil necessary for commuter scooters?"
    answer: "Scooters use a dry clutch, so there's no slipping issue. The JASO standard excludes 'RC/EC (Resource Conserving)' car oils with ultimate low-resistance technology. Sticking strictly to JASO means missing out on improved fuel efficiency and a lighter throttle response."
  - question: "Does the JASO standard conflict with API standards?"
    answer: "There is no conflict. JASO is an additional test. The oil must first meet API (SJ~SP) baseline standards before applying. However, JASO explicitly excludes high-end API certified oils labeled 'RC' (Resource Conserving) and 'EC' (Energy Conserving)."
  - question: "What are the benefits of MB 229.52 approval for motorcycles?"
    answer: "It requires extremely low evaporation loss (≤ 10%) and very high High-Temperature High-Shear (HTHS) viscosity (≥ 3.5 mPa·s), providing tougher physical protection. Additionally, 229.52 is a Mid-SAPS formula, which effectively protects the catalytic converters in Phase 7 emission standard motorcycles."
  - question: "How is the newly released API SQ certification better than the previous standard?"
    answer: "API SQ drastically improves 'Aged-Oil' protection and offers +30% piston cleanliness, maintaining strong anti-oxidation protection even at the end of the oil change interval, making it perfect for scooters with poorer engine cooling."
  - question: "Why does the article emphasize 'under 8000 RPM' as a dividing line?"
    answer: "The extremely strict anti-foaming test in the JASO standard is designed for the high-speed '10,000+ RPM' churning in the gearboxes of manual motorcycles. Most commuter scooters cruise around 5000~7000 RPM, where the anti-foaming capabilities of car oils are more than sufficient."
  - question: "Taiwan motorcycle shops generally recommend 10W-40, will European 5W-40 car oil be too thin?"
    answer: "This is a common misconception. '5W' represents cold start fluidity, while '40' represents high-temperature viscosity. To meet the HTHS ≥ 3.5 requirement, 5W-40 oils with MB 229.52 approval must use higher-grade base oils, offering protection and durability far exceeding budget 10W-40 oils."
---
...
1. **High-Temperature Oil Film Strength (HTHS): The Key to Protecting Air-Cooled Engines** * **JASO MB (2023):** The baseline standard only requires **≥ 2.9 mPa·s**.  
...
2. **Evaporation Loss (NOACK): Determining the Probability of Oil Burning** * **JASO MB (2023):** The tolerance limit is **≤ 15%**.  
...
3. **Catalytic Converter Friendliness:** MB 229.52 is a Mid-SAPS formula, which strictly limits sulfur, phosphorus, and ash content. It effectively prevents catalytic converter poisoning in Phase 7 emission standard motorcycles and extends the lifespan of the exhaust system.
...
| **High-Temp Oil Film (HTHS, mPa·s)** | RC (xW-30): ≥ 3.0 <br> **Non-RC (xW-40): ≥ 3.5** | **Extremely Strong (≥ 3.5)** | Baseline Standard (≥ 2.9) |
